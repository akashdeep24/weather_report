...
my_label=Label(window, text="",font=("Comic Sans MS", 15,), bg="sky blue")
...
btn=button = Button(window, text="Enter",bg="MistyRose", width=10,
 command=lambda: [delete_all_text(),sendcity(takecity), delete_city()])
